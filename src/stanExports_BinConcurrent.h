...
namespace model_BinConcurrent_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 17, column 4 to column 74)",
                                                      " (in 'string', line 16, column 2 to line 17, column 74)",
                                                      " (in 'string', line 19, column 4 to column 74)",
                                                      " (in 'string', line 18, column 2 to line 19, column 74)",
...
class model_BinConcurrent final : public model_base_crtp<model_BinConcurrent> {
private:
  int nCT;
  int nCC;
  int p;
...
public:
  ...
  inline std::string model_name() const final { return "model_BinConcurrent"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_BinConcurrent(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_BinConcurrent_namespace::model_BinConcurrent";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_BinConcurrent_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_BinConcurrent_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
...
using stan_model = model_BinConcurrent_namespace::model_BinConcurrent;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_BinConcurrent_namespace::profiles__;
}
#endif
#endif
