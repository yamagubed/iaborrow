...
namespace model_T2EHybrid_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 31, column 2 to line 32, column 79)",
                                                      " (in 'string', line 34, column 4 to column 79)",
                                                      " (in 'string', line 33, column 2 to line 34, column 79)",
                                                      " (in 'string', line 36, column 4 to column 79)",
                                                      " (in 'string', line 35, column 2 to line 36, column 79)",
                                                      " (in 'string', line 38, column 4 to column 80)",
                                                      " (in 'string', line 37, column 2 to line 38, column 80)",
                                                      " (in 'string', line 40, column 4 to column 80)",
                                                      " (in 'string', line 39, column 2 to line 40, column 80)",
                                                      " (in 'string', line 42, column 4 to column 80)",
                                                      " (in 'string', line 41, column 2 to line 42, column 80)",
                                                      ...
                                                      " (in 'string', line 21, column 2 to column 10)",
                                                      " (in 'string', line 25, column 9 to column 10)"};
#include <stan_meta_header.hpp>
class model_T2EHybrid final : public model_base_crtp<model_T2EHybrid> {
private:
  int nCT_o;
  int nCT_c;
  int nCC_o;
...
public:
  ...
  inline std::string model_name() const final { return "model_T2EHybrid"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_T2EHybrid(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_T2EHybrid_namespace::model_T2EHybrid";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_T2EHybrid_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      alpha = in__.scalar();
      {
        ...
        for (int i = 1; i <= nCT_o; ++i) {
          ...
          lp_accum__.add(
            weibull_lpdf<false>(yCT_o[(i - 1)], alpha,
              stan::math::exp(
        ...
        for (int i = 1; i <= nCC_o; ++i) {
          ...
          lp_accum__.add(
            weibull_lpdf<false>(yCC_o[(i - 1)], alpha,
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_T2EHybrid_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"gammaCC\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" << p << "},\"block\":\"parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"alpha\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"}]";
    return s__.str();
...
using stan_model = model_T2EHybrid_namespace::model_T2EHybrid;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_T2EHybrid_namespace::profiles__;
}
#endif
#endif
