...
namespace model_ContHybrid_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 22, column 4 to column 69)",
                                                      " (in 'string', line 21, column 2 to line 22, column 69)",
                                                      " (in 'string', line 24, column 4 to column 69)",
                                                      " (in 'string', line 23, column 2 to line 24, column 69)",
                                                      " (in 'string', line 26, column 4 to column 69)",
                                                      " (in 'string', line 25, column 2 to line 26, column 69)",
                                                      ...
                                                      " (in 'string', line 12, column 2 to column 10)",
                                                      " (in 'string', line 16, column 9 to column 10)"};
#include <stan_meta_header.hpp>
class model_ContHybrid final : public model_base_crtp<model_ContHybrid> {
private:
  int nCT;
  int nCC;
  int nEC;
...
public:
  ...
  inline std::string model_name() const final { return "model_ContHybrid"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_ContHybrid(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_ContHybrid_namespace::model_ContHybrid";
    ...
    try {
      ...
      context__.validate_dims("data initialization","yEC","double",
          context__.to_vec(nEC));
      yEC = Eigen::Matrix<double, -1, 1>(nEC);
      stan::math::fill(yEC, std::numeric_limits<double>::quiet_NaN());
      
      {
        std::vector<local_scalar_t__> yEC_flat__;
        current_statement__ = 20;
        assign(yEC_flat__, nil_index_list(), context__.vals_r("yEC"),
          "assigning variable yEC_flat__");
        current_statement__ = 20;
        pos__ = 1;
        current_statement__ = 20;
        for (int sym1__ = 1; sym1__ <= nEC; ++sym1__) {
          current_statement__ = 20;
          assign(yEC, cons_list(index_uni(sym1__), nil_index_list()),
            yEC_flat__[(pos__ - 1)], "assigning variable yEC");
          current_statement__ = 20;
          pos__ = (pos__ + 1);}
      }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_ContHybrid_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      }
      {
        ...
        for (int i = 1; i <= nCT; ++i) {
          ...
          lp_accum__.add(
            normal_lpdf<false>(yCT[(i - 1)],
              ((gammaCC + theta) + multiply(xCT[(i - 1)], beta)), sigma));}
        current_statement__ = 8;
        for (int i = 1; i <= nCC; ++i) {
          current_statement__ = 7;
          lp_accum__.add(
            normal_lpdf<false>(yCC[(i - 1)],
        ...
        for (int i = 1; i <= nEC; ++i) {
          ...
          lp_accum__.add(
            (a0 *
              normal_lpdf<false>(yEC[(i - 1)],
                (gammaCC + multiply(xEC[(i - 1)], beta)), sigma)));}
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_ContHybrid_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"gammaCC\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" << p << "},\"block\":\"parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"}]";
    return s__.str();
...
using stan_model = model_ContHybrid_namespace::model_ContHybrid;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_ContHybrid_namespace::profiles__;
}
#endif
#endif
