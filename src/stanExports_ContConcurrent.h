...
namespace model_ContConcurrent_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 18, column 4 to column 66)",
                                                      " (in 'string', line 17, column 2 to line 18, column 66)",
                                                      " (in 'string', line 20, column 4 to column 66)",
                                                      " (in 'string', line 19, column 2 to line 20, column 66)",
...
class model_ContConcurrent final : public model_base_crtp<model_ContConcurrent> {
private:
  int nCT;
  int nCC;
  int p;
...
public:
  ~model_ContConcurrent() { }
  
  inline std::string model_name() const final { return "model_ContConcurrent"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_ContConcurrent(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_ContConcurrent_namespace::model_ContConcurrent";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_ContConcurrent_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_ContConcurrent_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
...
using stan_model = model_ContConcurrent_namespace::model_ContConcurrent;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_ContConcurrent_namespace::profiles__;
}
#endif
#endif
