...
namespace model_BinHybrid_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 21, column 4 to column 77)",
                                                      " (in 'string', line 20, column 2 to line 21, column 77)",
                                                      " (in 'string', line 23, column 4 to column 77)",
                                                      " (in 'string', line 22, column 2 to line 23, column 77)",
                                                      " (in 'string', line 25, column 4 to column 77)",
                                                      " (in 'string', line 24, column 2 to line 25, column 77)",
...
class model_BinHybrid final : public model_base_crtp<model_BinHybrid> {
private:
  int nCT;
  int nCC;
  int nEC;
...
public:
  ...
  inline std::string model_name() const final { return "model_BinHybrid"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_BinHybrid(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_BinHybrid_namespace::model_BinHybrid";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_BinHybrid_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_BinHybrid_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"gammaCC\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" << p << "},\"block\":\"parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"}]";
    return s__.str();
...
using stan_model = model_BinHybrid_namespace::model_BinHybrid;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_BinHybrid_namespace::profiles__;
}
#endif
#endif
