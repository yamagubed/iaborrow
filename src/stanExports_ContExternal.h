...
namespace model_ContExternal_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 15, column 4 to column 63)",
                                                      " (in 'string', line 14, column 2 to line 15, column 63)",
                                                      " (in 'string', line 2, column 2 to column 19)",
                                                      " (in 'string', line 3, column 2 to column 17)",
                                                      " (in 'string', line 4, column 9 to column 12)",
                                                      " (in 'string', line 4, column 2 to column 18)",
                                                      " (in 'string', line 5, column 20 to column 23)",
                                                      " (in 'string', line 5, column 13 to column 14)",
                                                      " (in 'string', line 5, column 2 to column 25)",
                                                      " (in 'string', line 6, column 2 to column 10)",
                                                      " (in 'string', line 10, column 9 to column 10)"};
#include <stan_meta_header.hpp>
class model_ContExternal final : public model_base_crtp<model_ContExternal> {
private:
  int nEC;
  int p;
...
public:
  ...
  inline std::string model_name() const final { return "model_ContExternal"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_ContExternal(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_ContExternal_namespace::model_ContExternal";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_ContExternal_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_ContExternal_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"gammaCC\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" << p << "},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"}]";
    return s__.str();
...
using stan_model = model_ContExternal_namespace::model_ContExternal;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_ContExternal_namespace::profiles__;
}
#endif
#endif
